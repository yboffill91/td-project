      ...
      <div className='grid lg:grid-cols-2 gap-8 sm:gap-12 items-center'>
        ...
        <div className='text-center lg:text-left'>
          <h2 className='text-3xl sm:text-4xl font-bold mb-4'>
            <span className='text-oreground'>Don&apos;t Let Your</span>{' '}
            <span className='gradient-text'>Business</span>{' '}
            <span className='text-foreground'>Fall Behind</span>
          </h2>
          <p className='text-lg sm:text-xl text-foreground/50 mb-6 sm:mb-8'>
            In today&apos;s digital world, your online presence is your
            competitive advantage. Let&apos;s make it count.
          </p>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-8 lg:mt-0'>
          <div className='text-center p-6 rounded-xl bg-card/10 backdrop-blur-2xl backdrop-filter'>
